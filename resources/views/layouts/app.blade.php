...
<body ng-app="pagination">
    <div id="app">
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container" style="margin-left: 80px; display: inline-block;">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse" style="display: inline-block;">
                    <!-- Left Side Of Navbar -->
                    <div class="navbar-nav" style="width: 70%; height: 50px; margin-left: 20%">
                        <div style="display: inline-block; height: 100%; margin: auto; margin-left: 40%;" >
                            ...
                            <button><img src="{{ asset('logo/Notify2.jpg') }}" style="background-size: cover;" width="35px" height="35px" alt=""></button>
